...
```bash
bunx effect-language-service unpatch
```
...
```bash
bunx effect-language-service diagnostics
bunx effect-language-service diagnostics --fix  # Auto-fix where possible
```
...
```bash
bunx effect-language-service quickfixes
```
...
```bash
bunx effect-language-service overview
```
...
```bash
bunx effect-language-service layerinfo
bunx effect-language-service layerinfo --graph  # Output as graph
```
