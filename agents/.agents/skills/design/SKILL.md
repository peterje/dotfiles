---
name: design
description: Create polished, intentional design artifacts in HTML/CSS/SVG/JS, including prototypes, decks, UI explorations, design systems, and visual audits.
---
